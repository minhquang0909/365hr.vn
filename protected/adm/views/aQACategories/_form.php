...
<div class="form">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'parent_id', AQACategories::getListQACategoriesName(), array('prompt' => Yii::t('adm/news','select_categories'), 'class' => 'form-control', 'style' => 'width:250px !important;')); ?>
