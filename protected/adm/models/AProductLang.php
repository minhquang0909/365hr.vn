...
class AProductLang extends ProductLang
{
	...
	public function rules()
	{
		...
		return array(
			array('categories_id, title, slug, language_id, parent_id', 'required'),
            ...
            array('price, area,pax', 'numerical'),
			array('folder_path,short_des,full_des', 'safe'),
			array('short_des', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, categories_id, title, slug, short_des, full_des, folder_path, created_date, created_by, updated_date, updated_by, public_date, hot, sort_order, views, status, language_id, parent_id', 'safe', 'on'=>'search'),
		);
	}
