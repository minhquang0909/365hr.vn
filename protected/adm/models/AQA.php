<?php
    ...
    class AQA extends QA
    {
        ...
        public function rules()
        {
            ...
            return array(
                array('question,categories_id','required'),
        ...
        public function attributeLabels()
        {
            return array(
                ...
                'question'         => Yii::t('adm/news', 'question'),
                'slug'          => Yii::t('adm/news', 'slug'),
                'answer'      => Yii::t('adm/news', 'answer'),
        ...
        public function beforeSave()
        {
            if (parent::beforeSave()) {
                $this->slug = Utils::unsign_string($this->question);
