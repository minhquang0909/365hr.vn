...
class AContactsController extends AController
{
	...
	public $modelDisplayName='Liên hệ';
	public $modelDisplayAttribute='Liên hệ';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['AContacts']))
		{
			$model->attributes=$_POST['AContacts'];
			if($model->save())
	...
	{
		$model=new AContacts('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AContacts']))
			$model->attributes=$_GET['AContacts'];
	 ...
	 * @return AContacts the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AContacts::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AContacts $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='acontacts-form')
		{
