...
/**
 * This is the model class for table "{{news_categories_lang}}".
 *
 * The followings are the available columns in table '{{news_categories_lang}}':
 * @property string $id
 ...
 */
class NewsCategoriesLang extends CActiveRecord
{
    /**
