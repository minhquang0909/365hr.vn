 ...
 */
class QALang extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('categories_id, question, slug, short_des, answer, folder_path, created_date, created_by, updated_date, updated_by, public_date, sort_order', 'required'),
			...
			array('id, categories_id, question, slug, short_des, answer, folder_path, created_date, created_by, updated_date, updated_by, public_date, hot, sort_order, views, status, language_id, parent_id', 'safe', 'on'=>'search'),
		);
	}
