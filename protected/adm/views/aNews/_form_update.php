    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <?php $this->widget(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            'placeholder' => Yii::t('adm/news','placeholder_tags'),
                            'width' => '83%',
                ...
                <div style="margin: 10px 0;">
                    <label><?=Yii::t('adm/news','tags_selected')?></label>
                    <?php
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <?php echo $form->dropDownList($model, 'hot', array(1 => Yii::t('adm/news','yes'), 0 => Yii::t('adm/news','no')), array('options' => array(($model->isNewRecord) ? 1 : $model->status => array('selected' => TRUE)),'style'=>'width:200px')); ?>
