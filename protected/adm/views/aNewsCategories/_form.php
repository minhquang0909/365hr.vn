...
<div class="form">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'parent_id', ANewsCategories::getListNewsCategoriesName(), array('prompt' => Yii::t('adm/news','select_categories'), 'class' => 'form-control', 'style' => 'width:250px !important;')); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'in_home_page', array(1 => Yii::t('adm/news','yes'), 0 => Yii::t('adm/news','no')), array('options' => array(($model->isNewRecord) ? 1 : $model->status => array('selected' => TRUE)),'style'=>'width:200px')); ?>
...
<script>
    ...
    $("#ANewsCategories_file").change(function () {
        var ext = $('#ANewsCategories_file').val().split('.').pop().toLowerCase();
        if ($.inArray(ext, ['jpg', 'jpeg', 'png']) == -1) {
            $("#errorANewsCategories_file").remove();
            $('#ANewsCategories_file').after('<div class="errorMessage" id="errorANewsCategories_file"><?php echo Yii::t('adm/news','error_file_ext') ?></div>');
        } else {
            $("#errorANewsCategories_file").remove();
