...
class AQACategories extends QACategories
{
    public $file;
    public $old_file;
     ...
     *
     * @return QACategories the static model class
     */
    ...
    public static function getListQACategoriesName()
    {
        self::$_items = array();
        $cri = new CDbCriteria();
        $models       = self::model()->findAll(array(
            "condition" => "status = " . AQACategories::NEWS_CATE_ACTIVE,
            "group"     => "name"
        ));
    ...
    public function getNewsCategoriesName()
    {
        $model = '';
        if ($this->parent_id) {
            $model = AQACategories::model()->find('id=' . $this->parent_id);
        }
