...
class ProductLang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('categories_id, hot, sort_order, views, status, language_id, parent_id, pax, bedroom', 'numerical', 'integerOnly'=>true),
			...
			array('id, categories_id, title, slug, short_des, full_des, folder_path, created_date, created_by, updated_date, updated_by, public_date, hot, sort_order, views, status, language_id, parent_id, price, area, pax, bedroom', 'safe', 'on'=>'search'),
		);
	}
