...
class NewsLang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('categories_id, title, short_des, full_des, folder_path, created_date, created_by, updated_date, updated_by, public_date, sort_order, language_id, parent_id', 'required'),
