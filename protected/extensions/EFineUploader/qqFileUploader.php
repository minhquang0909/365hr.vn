<?php
    ...
    class qqFileUploader
    {
        ...
        public    $uploadFtp     = false;
        public    $ftp_start_dir = '';
        ...
        public function getFileInfo()
        {
            ...
            if (isset($_FILES[$this->inputName])) {
                return pathinfo($_FILES[$this->inputName]['name']);
            }
        }
        ...
        protected function getUniqueTargetPath($uploadDirectory, $filename)
        {
            ...
            if (!$this->uploadFtp) {
                ...
                $result = $this->ftp_start_dir.DIRECTORY_SEPARATOR.$uploadDirectory.DIRECTORY_SEPARATOR.$unique.$ext;
        ...
        protected function getUniqueFilename_Ftp($filename)
        {
