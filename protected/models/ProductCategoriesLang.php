...
/**
 * This is the model class for table "{{product_categories_lang}}".
 *
 * The followings are the available columns in table '{{product_categories_lang}}':
 * @property string $id
 ...
 */
class ProductCategoriesLang extends CActiveRecord
{
	/**
	...
	{
		return '{{product_categories_lang}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('name, slug, folder_path, sort_order, status', 'required'),
