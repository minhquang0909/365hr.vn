...
class ARecruitmentStepLang extends RecruitmentStepLang
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, categories_id, short_desc,answer, slug, answer, folder_path, created_date, created_by, updated_date, updated_by, public_date, hot, sort_order, views, status, language_id, parent_id', 'safe', 'on'=>'search'),
		);
	}
