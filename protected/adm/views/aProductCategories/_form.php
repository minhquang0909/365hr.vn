...
<div class="form">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'parent_id', AProductCategories::getListNewsCategoriesName(), array('prompt' => Yii::t('adm/product','select_categories'), 'class' => 'form-control', 'style' => 'width:250px !important;')); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'in_home_page', array(1 => Yii::t('adm/product','yes'), 0 => Yii::t('adm/product','no')), array('options' => array(($model->isNewRecord) ? 1 : $model->status => array('selected' => TRUE)),'style'=>'width:200px')); ?>
...
<script>
    ...
    $("#AProductCategories_file").change(function () {
        var ext = $('#AProductCategories_file').val().split('.').pop().toLowerCase();
        if ($.inArray(ext, ['jpg', 'jpeg', 'png']) == -1) {
            $("#errorAProductCategories_file").remove();
            $('#AProductCategories_file').after('<div class="errorMessage" id="errorAProductCategories_file"><?php echo Yii::t('adm/product','error_file_ext') ?></div>');
        } else {
            $("#errorAProductCategories_file").remove();
