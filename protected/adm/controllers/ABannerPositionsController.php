<?php
    ...
    class ABannerPositionsController extends AController
    {
        /**
        ...
        {
            $model = new ABannerPositions;

            // Uncomment the following line if AJAX validation is needed
            $this->performAjaxValidation($model);

            if (isset($_POST['ABannerPositions'])) {
                $model->attributes = $_POST['ABannerPositions'];
                if ($model->save())
        ...
        {
            $dataProvider = new CActiveDataProvider('ABannerPositions');
        ...
        {
            $model = new ABannerPositions('search');
            $model->unsetAttributes(); // clear any default values
            if (isset($_GET['ABannerPositions']))
                $model->attributes = $_GET['ABannerPositions'];
         ...
         *
         * @return ABannerPositions the loaded model
         * @throws CHttpException
         */
        public function loadModel($id)
        {
            $model = ABannerPositions::model()->findByPk($id);
            if ($model === NULL)
         ...
         *
         * @param ABannerPositions $model the model to be validated
         */
        protected function performAjaxValidation($model)
        {
            if (isset($_POST['ajax']) && $_POST['ajax'] === 'abanner-positions-form') {
        ...
        public function actionActive()
        {
            ...
            $sql         = " UPDATE {{banner_positions}} SET status = '" . $status_new . "' WHERE id = '" . $id . "' ";
