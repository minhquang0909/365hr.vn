...
/**
 * This is the model class for table "{{qa_categories_lang}}".
 *
 * The followings are the available columns in table '{{qa_categories_lang}}':
 * @property string $id
 ...
 */
class QACategoriesLang extends CActiveRecord
{
    /**
