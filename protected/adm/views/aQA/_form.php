    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <?php echo $form->dropDownList($model, 'categories_id', AQACategories::getListQACategoriesName(), array('prompt' => Yii::t('adm/news','select_categories'), 'class' => 'form-control', 'style' => 'width:245px;')); ?>
