            ...
            if (isset($_POST['ANewsCategories'])) {
                ...
                if ($model->validate()) {
                    ...
                    if ($model->save()) {
                        ...
                        foreach ((array)$data_lang as $k => $v) {
                            $lang_detail = ALanguages::model()->find("code_name='$k'");
                            $item = ANewsCategoriesLang::model()->find("category_id=$model->id and language_id=$lang_detail->id");
                            if(!$item){
                                $item              = new ANewsCategoriesLang();
                            }
                            Languages::copyAllAttributes($item,$model);
                ...
                $data_lang_detail = ANewsCategoriesLang::model()->findAll('category_id='.$model->id);
