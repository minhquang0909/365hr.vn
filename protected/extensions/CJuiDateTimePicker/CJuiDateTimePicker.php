<?php
    ...
    class CJuiDateTimePicker extends CJuiDatePicker
    {
        ...
        public function run()
        {
            ...
            if ($this->hasModel())
                echo CHtml::activeTextField($this->model, $this->attribute, $this->htmlOptions).'<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>';
            else
                echo CHtml::textField($name, $this->value, $this->htmlOptions).'<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>';
