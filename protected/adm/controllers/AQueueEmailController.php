...
class AQueueEmailController extends AController
{
	...
	{
		$model=new AQueueEmail;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['AQueueEmail']))
		{
			$model->attributes=$_POST['AQueueEmail'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('AQueueEmail');
	...
	{
		$model=new AQueueEmail('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AQueueEmail']))
			$model->attributes=$_GET['AQueueEmail'];
	 ...
	 * @return AQueueEmail the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AQueueEmail::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AQueueEmail $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aqueue-email-form')
		{
