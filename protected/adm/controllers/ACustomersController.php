<?php
    ...
    class ACustomersController extends AController
    {
        /**
        ...
        public function accessRules()
        {
            return array(
                ...
                array(
                    ...
                    'actions' => array('create', 'update', 'transactionLogs'),
                    'users'   => array('@'),
                ),
                array(
         ...
         * Manages all models.
         */
        public function actionTransactionLogs($id)
        {
            $model = new AEbankLogs('search');
            $model->unsetAttributes();
            if (isset($_GET['AEbankLogs'])) {
                $model->attributes = $_GET['AEbankLogs'];
            }
            $model->ebank_id = $id;
            $this->render('transactionLogs', array(
                'model' => $model,
            ));
        }
